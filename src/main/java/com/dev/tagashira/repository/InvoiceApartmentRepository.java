...
public interface InvoiceApartmentRepository extends JpaRepository<InvoiceApartment, Long>, JpaSpecificationExecutor<InvoiceApartment> {
    @Query("SELECT new com.dev.tagashira.dto.response.InvoiceApartmentResponse(ia.invoice.id, ia.invoice.name, ia.invoice.description, ia.invoice.updatedAt, ia.invoice.createdAt, ia.paymentStatus, null) " +
